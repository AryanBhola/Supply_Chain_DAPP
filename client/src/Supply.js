...
return (
    <div className="container">
        <div className="account-section">
            <span><b>Current Account Address:</b> {currentaccount}</span>
            <span onClick={redirect_to_home} className="btn-home">HOME</span>
        </div>
        ...
        <div className="step-section">
            ...
            <form className="role-form" onSubmit={handlerSubmitRMSsupply}>
                ...
                <button className="btn-action">Supply</button>
            </form>
        </div>
        ...
        <div className="step-section">
            ...
            <form className="role-form" onSubmit={handlerSubmitManufacturing}>
                <input className="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn-action">Manufacture</button>
            </form>
        </div>
        ...
        <div className="step-section">
            ...
            <form className="role-form" onSubmit={handlerSubmitDistribute}>
                <input className="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn-action">Distribute</button>
            </form>
        </div>
        ...
        <div className="step-section">
            ...
            <form className="role-form" onSubmit={handlerSubmitRetail}>
                <input className="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn-action">Retail</button>
            </form>
        </div>
        ...
        <div className="step-section">
            ...
            <form className="role-form" onSubmit={handlerSubmitSold}>
                <input className="form-control" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn-action">Sold</button>
            </form>
        </div>
