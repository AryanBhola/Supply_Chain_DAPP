...
import './App.css'; // Assuming you have the CSS from the previous section
...
function AddMed() {
    ...
    return (
        <div className="add-med-container">
            ...
            <h5 className="section-title">Add Medicine Order:</h5>
            <form onSubmit={handlerSubmitMED} className="med-form">
                <input
                    className="form-control-sm input-field"
                    type="text"
            ...
            <br />
            <h5 className="section-title">Ordered Medicines:</h5>
